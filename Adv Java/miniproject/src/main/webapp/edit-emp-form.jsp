...
<div style="position:absolute; top:0px; width: 100%"><%@ include file="component/header1.jsp" %></div>
 ...
 <form class="col-md-4" action="UpdateServlet" method="post" style="margin-top: 10%">
<div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">eId</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputmobile3" name="empId">
    </div>
  </div>
 ...
 <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputname3" name="empName">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputmobile3" name="empMobile">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" name="empAddress">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">salary</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputPassword3" name="empSalary">
    </div>
  </div>
